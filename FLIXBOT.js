...
let audio = {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: 'RAFFX SALAM',
        sourceUrl: '',
        thumbnail: await (await Fernazerini.getFile('https://telegra.ph/file/d6f44478fd2ece636755e.jpg')).data,
...
console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m FernazeriniChat \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
            }
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
            {
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"YOUTUBE\",\"url\":\"https://youtube.com/Fernazer\",\"merchant_url\":\"https://www.google.com\"}"
              },              
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"GITHUB\",\"url\":\"https://github.com/Fernazer\",\"merchant_url\":\"https://www.google.com\"}"
              },                          
              {
                "name": "quick_reply",
...
case 'socialmedia': 
    ...
    [
        ...
        'https://youtube.com/Fernazer', // Command (URL in this case)
        'cta_url', // Button type
        'https://youtube.com/Fernazer' // URL (used in image generation)
    ], 
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'http://t.me/Fernazerini', // Command (URL in this case)
        'cta_url', // Button type
        'http://t.me/Fernazerini' // URL (used in image generation)
    ], 
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://github.com/Fernazer', // Command (URL in this case)
        'cta_url', // Button type
        'https://github.com/Fernazer' // URL (used in image generation)
    ], 
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://www.instagram.com/raffxzer', // Command (URL in this case)
        'cta_url', // Button type
        'https://www.instagram.com/raffxzer' // URL (used in image generation)
    ], 
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://Wa.me/6281328139682', // Command (URL in this case)
        'cta_url', // Button type
        'https://Wa.me/6281328139682' // URL (used in image generation)
    ], 
];
...
anyone like it? please upgrade Premium User to owner / Fernazerini`
  Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/ac7b0762c24dff7940978.jpg" }, caption: teks28 }, { quoted: fcall })
}
...
break
case 'sc': case 'script': {
tut = `Kakak Tidak Bisa Menggambil Script Ini Secara Gratis ,, Tetapi Kakak Bisa Membeli Ny Di Fernazerini Atau Owner`
await Fernazerini.sendMessage(m.chat, {audio: fs.readFileSync('./Vn/sc.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:m})}
break
case 'sewa': case 'bot': case 'sewabot': case 'flixbot': {
reply(` List Sewa FliX BOT AI 
  • Permanen [ 20K ]
  • 4Hari [ 3K ]
  • 7Hari [ 5K ]
  • 10Hari [ 7K ]
...
Jika Ingin Menyewa FliX BOT AI Silahkan Ketik .pembayaran 
`)
}
break
case 'delprem': {
...
break
case "bcimg": {
if (!isCreator) return reply(`ᴋʜᴜsᴜs RAFFX DEVELOPER ᴅᴏᴀɴᴋ ʟᴏʟ`)
...
break
case 'restart':
if (!isCreator) return reply('ᴋʜᴜsᴜs RAFFX DEVELOPER ᴅᴏᴀɴᴋ')
reply(`ᴍʀᴇsᴛᴀʀᴛ RAFFX DEVELOPER....`)
await sleep(3000)
process.exit()
break
case 'runtime': {
...
break
case 'delcase': {
if (!isCreator) return reply(`ᴋʜᴜsᴜs RAFFX DEVELOPER ᴀᴊ ʟᴏʟ`)
...
break
case "listgc":{
if (!isCreator) return (`ᴋʜᴜsᴜs RAFFX DEVELOPER ᴀᴋ ʟᴏʟ ᴡᴋᴡᴋ`)
let getGroups = await Fernazerini.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let hituet = 0
...
break
case 'antilink': {
if (!isCreator) return reply('*khusus Fernazerini Aj Su*')
...
reply('FliX BOT AI SUKSES MODE PUBLIC')
}
break
case 'self': {
if (!isCreator) return mess.owner
Fernazerini.public = false
reply('FLIX BOT AI SUCCES MODE SELF')
}
break
//================ D O W N L O A D ==================//
...
if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
if (!text) return reply(`ʟɪɴᴋ ɴʏ ᴍɴ ʙɪᴀʀ RAFFX DEVELOPER ᴘʀᴏsᴇs`)
let old = new Date()
...
contextInfo: {
externalAdReply: {
title: `sᴘᴏᴛɪғʏ ʙʏ RAFFX DEVELOPER`,
body: "",
...
Done Bwang Kuhhh Kamu Sekarang Sudah Bisa Mengakses FliX BOT AI Abangkuhh Btw Litim Gada Reset Reset an Jika Limit Habis Silahkan Buy Limit Di Fernazerini`
veri = m?.sender
if (!m.isGroup) {
...
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = true
reply('SUCCES PUBLIC KAK Fernazerini')
}
break
case 'self': {
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = false
reply('SUCCES SELF KAK Fernazerini')
}
break
...
break
      ...
      case "listsw": {
        ...
        break;
case 'emojimix': { 
if (isBan) return m.reply('ʟᴜ ᴅɪ ʙᴀɴ ᴏʟᴇʜ RAFFX DEVELOPER')
await loading()
...
break 
        case 'group': {   
if (!isCreator) return m.reply('ᴋʜᴜsᴜs RAFFX DEVELOPER')
if (!m.isGroup) return m.reply('ᴋʜᴜsᴜs ɢʀᴏᴜᴘ')
...
Fernazerini.sendMessage(m.chat, { image: ppnyauser, caption: `ᴄᴏɴᴛᴏʜ ; .RAFFX DEVELOPER ᴛᴜᴛᴜᴘ ɢʀᴏᴜᴘ
ᴄᴏɴᴛᴏʜ : .RAFFX DEVELOPER ʙᴜᴋᴀ ɢʀᴏᴜᴘ`}, {quoted:m}) 
 }
}
break
case "antitoxic":
...
case '1gb': {
        if (!isPrem) return reply(`ᴋʜᴜsᴜs RAFFX DEVELOPER`)
...
break
case "2gb": {
    if (!isPrem) return reply(`Anda Belum Menjadi Reseler Beli Reseler Skrng Di Fernazerini agar Bisa Mengakses Fitur Cpanel`)
...
break
case "8gb": {
if (!isPrem) return reply(`ʙᴜʏ ᴘʀᴇᴍ ᴅʟᴜ ᴅɪ RAFFX DEVELOPER`)
let t = text.split(',');
if (t.length < 2) return reply(`*Format salah!*
Penggunaan:
${prefix + command} user,nomer`)
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 newsletterName: 'Powered By RAFFX DEVELOPER', 
 serverMessageId: -1
},
 ...
 title: `ʙᴜʏ ᴘᴀɴᴇʟ ʀᴇᴋ`,
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/9e9076678d390b21556e5.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
 buttons: [ 
 {
...
break
case "detusr": {
if (!isCreator) return reply(`*Anda Belum Menjadi Reseler Beli Reseler Skrng Di Fernazerini agar Bisa Mengakses Fitur Cpanel!*`)
let usr = args[0]
...
break
case "listsrv": {
  if (!isCreator) return reply(`ᴋʜᴜsᴜs RAFFX DEVELOPER.`);
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 header: proto.Message.InteractiveMessage.Header.create({
 title: Styles(`ʙᴜʏ ᴘᴀɴᴇʟ ᴅ RAFFX DEVELOPER ʏᴏᴋ`),
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/9e9076678d390b21556e5.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
...
case 'tutorial': {
await loading()
tut = `ᴛᴜᴛᴏʀ ʀᴜɴ ᴘᴀɴᴇʟ ʙʏ RAFFX DEVELOPER
...
case 'backup':
        {
          if (!isCreator) return reply(mess.owner)
     await reply("ᴡᴀɪᴛ ʙᴀᴄᴋᴜᴘ sᴄ RAFFX DEVELOPER ᴠ4.5");
          ...
          await Fernazerini.sendMessage(
            m.chat,
            {
              ...
              fileName: "RAFFXv3.7.zip",
            },
            { quoted: fcall }
          );
          await execSync("rm -rf RAFFX.zip");
        }
        break
//=================================================//
case 'buatgc': 
...
👤 Gw Ga Open Publick Kalo Harga ,, Kalo Mau Lihat Harga Pm Gw Aj Atau Owner
 `
 Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/5cd5c7ab7ec5b459cf7ca.jpg" }, caption: teks28 }, { quoted: fcall })
}
 break
 case 'vps': {
 reply(` Ready Vps FernazeriniXD
...
break
case 'panel': {
reply(` List? Ke 6281328139682 / Owner`)
}
break
//=================================================//
case "jarak":{
...
case "linode8gb": {
  if (!isCreator) return reply(`Khusus Fernazerini Saja Suki`);
  try {
    let linodeData = {
      label: `${args[0]}`,
...
𝗧𝗲𝗿𝗶𝗺𝗮𝗸𝗮𝘀𝗶𝗵 𝗧𝗲𝗹𝗮𝗵 𝗢𝗿𝗱𝗲𝗿 𝗗𝗶 Fernazerini
...
Itulah Rules FliX BOT AI Kak Jangan Langgar Ya Kak`)
             await Fernazerini.sendMessage(m.chat, {audio: fs.readFileSync('./Vn/rulesy.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:m})}
             break
             case 'formatneed': {
             reply(`*FORMAT NEED AKUN BY FernazeriniXD*
_NOTE!!! : INI BUKAN 100% AKUN MILIK ADMIN ATAU Fernazerini TETAPI AKUN MILIK SELER!!!_
...
_JANGAN LUPA SLALU MENGGUNAKAN JASA ADMIN FernazeriniXD AGAR TERHINDAR DARI PENIPUAN ATAU MODUS LAINNY_`)
}
break
case 'formatjp': {
reply(`*FORMAT JASA PSOT AKUN BY FernazeriniXD*
...
break
case 'feerekber': {
reply(`ALL FEE REKBER DI Fernazerini HANYA 5K`)
}
break
case 'feegc': {
reply(`langsung culik 6281328139682 / Fernazerini`)
}
break
case 'donasi': {
teks28 = `*『 DONASI 』*
Terimakasih Telah Berdonasi Kak Fernazerini akan Terus Mengembangkan Bot ini Insyaallah

Dana: 6281328139682
Qris : saweria.co/Fernazeriniyoshi

Jangan Lupa Send Bukti TF `
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/9e9076678d390b21556e5.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
case "gempa": {
...
if (!isAdmins) return m.reply('ᴋʜᴜsᴜs ᴀᴅᴍɪɴ ɢʀᴏup')
                ...
                case 'invite': {
	if (!m.isGroup) return reply(`khusus group`)
	if (!isBotAdmins) return reply(`flixbot belum admin`)
if (!text) return reply(`Enter the number you want to invite to the group\n\nExample :\n*${prefix + command}* 6281328139682`)
...
if (!isCreator) return (`khusus Fernazerini`)
if (args[0] == 'on'){
...
break
case 'paptt1': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di Fernazerini Wkwk`)
teks28 = `SANGEAN KONTOL`
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/8fb304f891b9827fa88a5.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
case 'paptt2': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di Fernazerini Wkwk`)
teks28 = `SANGEAN KONTOL`
Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/a5730f376956d82f9689c.jpg" }, caption: teks28 }, { quoted: fcall })
}
break
case 'paptt3': {
if (!isPrem) return reply(`Buy Prem Dlu Lah Di Fernazerini Wkwk`)
...
Fernazerini.sendMessage(m.sender, { image: { url: yeha }, caption : '© FliX BOT AI 2023 - 2024'}, { quoted: m })
}
break
case 'tiktokgirl':
await loading()
...
if (!m.isGroup) return reply(`Khusus Group`)
if (!isAdmins) return reply(`Khusus admin`)
if (!isBotAdmins) return reply(`Jadikan Flixbot Admin Dulu`)
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281328139682',
title: `FernazeriniXD`,
sourceUrl: `https://wa.me/+6281328139682`, 
thumbnail: thumb
}
}})
break
...
break   
case 'dana': {
reply(`Dana : 081328139682 Bukti? ketik .bukti dana 1000`)
}
break
case 'saldo':{
...
ITU ADALAH E-WALET YANG DI GUNAKAN KAK Fernazerini`)
}
break   
case 'bukti':{
...
Fernazerini.sendMessage('6281328139682@s.whatsapp.net', { text: `*ADA YANG DEPOSIT NIH*\n\n*@${sender.split('@')[0]}`, mentions: [sender]}, { quoted: m })
        }
        break
        case 'dana': {
        reply(`Dana : 081328139682 Ss Bukti Dengan Cara .bukti Dana 1000`)
        }
        break
        case 'qris': {
await loading()
...
*ɴᴏᴛᴇ* : _ᴊɪᴋᴀ ꜱᴜᴅᴀʜ ᴛʀᴀɴꜱꜰᴇʀ ꜱɪʟᴀʜᴋᴀɴ ᴋᴇᴛɪᴋ ᴄᴏɴᴛᴏʜ : .ʙᴜᴋᴛɪ Qʀɪꜱ5ᴋ ,, ᴅᴀɴ ꜱᴇʀᴛᴀᴋᴀɴ ɴᴀᴍᴀ ᴘᴇɴɢɪʀɪᴍ ᴇ-ᴡᴀʟᴇᴛ ᴄᴏɴᴛᴏʜ : ᴀᴛᴀꜱ ɴᴀᴍᴀ ᴅᴀɴᴀ : RAFFX DEVELOPER ʜᴀɴʏᴀ ᴄᴏɴᴛᴏʜ ,, ᴊɪᴋᴀ ᴛɪᴅᴀᴋ ᴍᴇɴɢɪᴋᴜᴛɪ ᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪ ᴘʀᴏꜱᴇꜱ_
...
break
       case 'nowa': {
if (!isCreator) return reply(`Khusus Fernazerini Aja`)
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 newsletterName: 'Powered By FernazeriniDev', 
 serverMessageId: -1
},
 businessMessageForwardInfo: { businessOwnerJid: Fernazerini.decodeJid(Fernazerini.user.id) },
 }, 
...
_SCRIPT FliX BOT AI V6_
_TYPE CASE_

BASE : HWMODS
FEATURE : FernazeriniXD
PENGEMBAN : FernazeriniXD
...
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./Inimedia/image/Fernazerini.jpg`),
"sourceUrl": `http://wa.me/+6281328139682`}}},
{ quoted: m})
}
break
        case "sad1":
...
mediaType:  1,
mediaUrl: 'https://youtube.com/@FernazeriniYete-',
title: `Converter mp3`,
...
buttons: [{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"No\",\"url\":\"https://wa.me/6281328139682\",\"merchant_url\":\"https://wa.me/6281328139682\"}`
}, {
"name": "cta_url",
